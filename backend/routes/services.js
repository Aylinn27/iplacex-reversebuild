...
router.post('/', async (req, res) => {
  try {
    ...
    console.error('[Services] Error al crear servicio:', err);
...
router.post('/:id/pasos', async (req, res) => {
  try {
    ...
    console.error('[Services] Error al guardar paso:', err);
...
router.get('/:id/rearme', async (req, res) => {
  try {
    ...
    console.error('[Services] Error al obtener rearme:', err);
...
router.put('/:id/finalizar', async (req, res) => {
  try {
    ...
    console.error('[Services] Error al finalizar servicio:', err);
